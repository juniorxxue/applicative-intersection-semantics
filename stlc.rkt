...
(test-equal (judgment-holds (appsub Empty Int Int)) #t)
(test-equal (judgment-holds (appsub (Empty : Int) (Int → Int) Int)) #t)
(test-equal (judgment-holds (appsub (Empty : Int) ((Int → Int) & (Bool → Bool)) Int)) #t)
